...
// Import the Unity Engine UI library for the Button.
// Import the System Linq library for the Select method to handle the array of fast travel spots.

// Import the Unity Engine Input System library for the InputAction.CallbackContext.

// Import the Unity Engine Scene Management library for the SceneManager.
...
public class WristUIPauseManage : MonoBehaviour
{
    ...
    public bool
        turnOnWristPauseUI =
            true; // A boolean to turn on the wrist pause UI when a specific button is pressed(X button on left VR controller).
    ...
    */
    ...
    {
        if (context.performed) ShowUIForWristPause();
    }
    ...
    /// <summary>
    ///     Description: Task #258 - Adding the additional function, which is to Go to the Mars Site 3 Scene, from Mars Site 2
    ///     or Mars Site 1.
    ///     Contribution: jlgrijal(Jose)
    ///     Date: 02/15/2025
    /// </summary>
    ...
    /// <summary>
    ///     Description: Task #258 - Adding the additional function, which is to Go to the Mars Site 2 Scene, from Mars Site 3
    ///     or Mars Site 1.
    ///     Contribution: jlgrijal(Jose)
    ///     Date: 02/15/2025
    /// </summary>
    ...
    /// <summary>
    ///     Description: Task #258 - Adding the additional function, which is to Go to the Mars Site 1 Scene, from Mars Site 3
    ///     or Mars Site 2.
    ///     Contribution: jlgrijal(Jose)
    ///     Date: 02/15/2025
    /// </summary>
    ...
    public void SetUpFastTravel()
    {
        ...
        for (int i = 0; i < extraTeleportSpots.Length; i++) m_TeleportSpots[i] = extraTeleportSpots[i];
